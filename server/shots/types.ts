...
export interface ShotJobRecord extends ShotJob {
...
export interface LegacyBackupSummaryItem {
  id: string;
  name: string;
  target_id: string;
  policy: string;
...
export interface CreateShotJobInput {
  friendly_name: string;
  description?: string;
  tags?: string[];
  target_host_id?: ShotTargetHostId;
...
export type UpdateShotJobInput = Partial<CreateShotJobInput>;
